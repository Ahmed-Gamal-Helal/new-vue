<!-- المقارنه -->
<template id="page-comparison">
  <f7-page>
    <f7-navbar title="المقارنه" back-link="Back"></f7-navbar>
      ...
      <div class="row professional-cam">
        <div class="col s6">
          <div class="repeated-product mt-2">
            ...
            <!-- <a href="#" class="like-it deleted-one">
    ...
    <f7-block><f7-view hash="/myfooter/"></f7-view></f7-block>
  </f7-page>
</template>
